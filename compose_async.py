...
from LoRA_Cache.pipelines.stable_diffusion.pipeline_async import StableDiffusionPipeline
    ...
    for combo in tqdm(combinations):
        ...
        for inter in range(len(args.interval)):
            ...
            image = pipeline(
                ...
                dom_lora_coeff=args.dom_lora_coeff,
                combo = combo,
            ).images[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--g', default=0.68, type=float)
